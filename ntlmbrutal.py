...
max_delay = 9000  # Maximum delay in milliseconds
...
for i, user in enumerate(users):
    if i < len(passwords):  # Check if a corresponding password exists
        ...
        os.system(f"{cmd}{username_password} {url} -o temp_output.html")
        
        # Check if the file size of temp_output.html is zero
